...
Section "FRAME3DD (required)"
	...
	File "examples\exA.3dd"
	File "examples\exB.3dd"
	File "examples\exC.3dd"
	File "examples\exD.3dd"
	File "examples\exE.3dd"
	File "examples\exF.3dd"
	File "examples\exG.3dd"
	File "examples\exH.3dd"
	File "examples\exI.3dd"
...
;--- common components ---
	...
	Delete "$INSTDIR\examples\exA.3dd"
	Delete "$INSTDIR\examples\exB.3dd"
	Delete "$INSTDIR\examples\exC.3dd"
	Delete "$INSTDIR\examples\exD.3dd"
	Delete "$INSTDIR\examples\exE.3dd"
	Delete "$INSTDIR\examples\exF.3dd"
	Delete "$INSTDIR\examples\exG.3dd"
	Delete "$INSTDIR\examples\exH.3dd"
	Delete "$INSTDIR\examples\exI.3dd"	
